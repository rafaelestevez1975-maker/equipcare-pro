...
export const db = {
  ...
  logistics: {
    getAll: () => getClient().from('logistics').select('*, equipment(brand,model,serial)').order('event_date', { ascending: false }),
    insert: (data) => getClient().from('logistics').insert(data).select().single(),
    update: (id, data) => getClient().from('logistics').update(data).eq('id', id).select().single(),
  ...
  tips: {
    getAll: () => getClient().from('tips').select('*, equipment(brand,model,serial)').order('created_at', { ascending: false }),
    insert: (data) => getClient().from('tips').insert(data).select().single(),
    update: (id, data) => getClient().from('tips').update(data).eq('id', id).select().single(),
    delete: (id) => getClient().from('tips').delete().eq('id', id),
  },
  tip_movements: {
    getAll: () => getClient().from('tip_movements').select('*, equipment(brand,model,serial)').order('movement_date', { ascending: false }),
    insert: (data) => getClient().from('tip_movements').insert(data).select().single(),
    update: (id, data) => getClient().from('tip_movements').update(data).eq('id', id).select().single(),
    delete: (id) => getClient().from('tip_movements').delete().eq('id', id),
  },
  tip_purchases: {
    getAll: () => getClient().from('tip_purchases').select('*').order('purchase_date', { ascending: false }),
    insert: (data) => getClient().from('tip_purchases').insert(data).select().single(),
    update: (id, data) => getClient().from('tip_purchases').update(data).eq('id', id).select().single(),
    delete: (id) => getClient().from('tip_purchases').delete().eq('id', id),
  },
  tip_audits: {
    getAll: () => getClient().from('tip_audits').select('*, tips(serial,tip_type)').order('audit_week', { ascending: false }),
    insert: (data) => getClient().from('tip_audits').insert(data).select().single(),
    update: (id, data) => getClient().from('tip_audits').update(data).eq('id', id).select().single(),
    delete: (id) => getClient().from('tip_audits').delete().eq('id', id),
  },
}
